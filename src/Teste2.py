...
class FloatingWindow(tk.Tk):
    ...
    def get_horas(self):
        ...
        self.after(100, self.get_horas)

    def ajustar_fonte(self,event):
        largura_janela = self.winfo_width()    
        tamanho_fonte = int(largura_janela / 6)
        self.label.config(font=("Helvetica", tamanho_fonte))
